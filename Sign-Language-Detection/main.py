...
def main():
    ...
    #listview1["columns"] = ("1")
    #listview1.column("#0", width=200, minwidth=200)
    #listview1.column("1", width=200, minwidth=200)
    #listview1.heading("#0", text="Hakkında")
    #listview1.heading("1", text="")
   ...
   # Ana Sayfa Listview
    ...
    listview2["columns"] = ("1")
    listview2.column("#0", width=300, minwidth=200)
    listview2.heading("#0", text="Bilgiler", anchor=tk.CENTER)  # Başlığı ortala
    ...
    #listview3["columns"] = ("1")
    #listview3.column("#0", width=200, minwidth=200)
    #listview3.column("1", width=200, minwidth=200)
    #listview3.heading("#0", text="İletişim")
    #listview3.heading("1", text="")
